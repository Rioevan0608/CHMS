...
import FormDialog from "./modal/OccupationModal";
...
function OccupationForm() {
    ...
    const url = `http://localhost:5000/api/occupation/`;
    // const url = `http://frederickdumalawoffice.id/api/occupation/`;
    const columnDefs = [
    ...
    const columns = [
        ...
        { headerName: "Occupation", field: "occupation", width: 200 },
        { headerName: "Pekerjaan", field: "pekerjaan", width: 200 },
        {
            field: "action",
            headerName: "Actions",
            sortable: false,
    ...
    return (
        <div className="App">
            <h1 align="center">Occupation Setup</h1>
            <Grid align="right">
...
export default React.memo(OccupationForm, comparisonFn);
