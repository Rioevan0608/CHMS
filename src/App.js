...
const App = () => {
    ...
    const menu = [
      ...
      
        {
            ...
            items: [
                { label: 'News Page', icon: 'pi pi-fw pi-calendar', to: '/News Page' },
                { label: 'Speaker', icon: 'pi pi-fw pi-circle-off', to: '/Speaker' },
                { label: 'User', icon: 'pi pi-fw pi-circle-off', to: '/User' },
                { label: 'Employees', icon: 'pi pi-fw pi-circle-off', to: '/Employees' },
                { label: 'Province', icon: 'pi pi-fw pi-circle-off', to: '/Province' },
